...
const data = [
    { number: 5, text: 'Web Projects Completed' },
...
const Accomplishments = () => (
    <section className="flex flex-col items-start px-4 sm:px-8 md:px-10 lg:px-14 py-8 max-w-7xl mx-auto sm:mx-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-6 sm:mt-8 w-full">
            {data.map((card, index) => (
                <div key={index} className="bg-[#591c8748] rounded-lg p-4 sm:p-6 shadow-lg transform transition-transform hover:scale-105 md:w-[90%]">
